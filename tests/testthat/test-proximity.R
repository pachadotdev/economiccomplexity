test_that("proximity results are aligned with the expected output ", {
  ...
  expect_equal(nrow(proximity_m$countries_proximity), 9)
  expect_equal(ncol(proximity_m$countries_proximity), 9)
  expect_equal(nrow(proximity_m$products_proximity), 12)
  expect_equal(ncol(proximity_m$products_proximity), 12)
  ...
  expect_equal(nrow(proximity_t$countries_proximity), 19)
  expect_equal(ncol(proximity_t$countries_proximity), 3)
  expect_equal(nrow(proximity_t$products_proximity), 33)
