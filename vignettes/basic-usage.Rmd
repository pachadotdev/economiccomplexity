...
pro$country_proximity
pro$product_proximity
```
...
```{r}
net <- networks(
  country_proximity = pro$country_proximity,
  product_proximity = pro$product_proximity,
