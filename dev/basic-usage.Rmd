...
pro$countries_proximity[1:5,1:5]
pro$products_proximity[1:5,1:5]
```
...
```{r}
# net <- networks(
#   pro$countries_proximity,
#   pro$products_proximity,
#   c_cutoff = 0.3,
#   p_cutoff = 0.6,
#   tbl_output = T
# )
# 
# net$countries_network
# net$products_network
```
...
# set.seed(1810)
# 
# countries_network <- graph_from_data_frame(net$countries_network, directed = F)
# 
# plot(
#   countries_network, 
